    ...
    <>
            ...
            >
              ...
              <div className="d-flex position-absolute end-0">
                {LoggedIn ? (
                  ...
                  <Nav.Link href="/#/signIn" className="me-3 position-relative">
                    Sign In
                  </Nav.Link>
                )}
                {LoggedIn ? (
                  ...
                  <Nav.Link href="/#/signUp" className="me-3 position-relative">
                    Sign Up
                  </Nav.Link>
                )}
              </div>
      ...
      <Router>
        <Routes>
          <Route
            path="/"
            element={((<HomePage />), (<BackgroundImg />))}
          ></Route>
          <Route
            path="/search"
            element={<Searchbar searched={searched} logged={LoggedIn} />}
          ></Route>
          <Route
            path="/profile"
            element={<Profile logged={LoggedIn} />}
          ></Route>
          <Route
            path="/signUp"
            element={<SignUpPage logged={LoggedIn} />}
          ></Route>
          <Route
            path="/signIn"
            element={<SignInPage logged={LoggedIn} />}
          ></Route>
        </Routes>
      </Router>
    </>
